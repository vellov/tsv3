...
exports.findUserTroubleshooters = function(req, res){
    utils.verifyToken(req.headers.authorization, function(err, decoded){
        UserAccessService.findTroubleshootersWithAccess(decoded._id, function(troubleshooters){
            res.send(troubleshooters);
        }, function(err){
            res.send(err);
        });
    });
